...
$sql = "select * from cec_sinhvientam INNER JOIN cec_chuyennganh ON cec_sinhvientam.ID_CHUYENNGANH = cec_chuyennganh.ID_CHUYENNGANH order by SOHOSO DESC LIMIT 6";
$query = $con->query($sql);
...
if($total_row > 0) {
    ...
    $output .= '
    <tr>
        <td hidden><p center>Không có dữ liệu...</p></td>
        <th scope="col"></th>
    </tr>
    ';
}
